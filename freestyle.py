...
wordz = [greetings, be, r1, r2, r3, r4, r5, r6, r7, sports, fruits, veggies, art, landscape, mystical]
...
def rap():
    # rando1 = randint(0,4)
    bar = ' '.join(random.choice(wordz[randint(0,14)]) for _ in range(random.choice(barLen)))
